...
from ..drawers.random_hpluv_color_drawer import RandomHPLuvColorDrawer
from ..processor import Processor
from ..timer import Timer


class RandomExample(Processor):
    ...
    def __init__(
        ...
        *,
        ...
        alpha = mp.pi - 2*beta
        self.tree = TriangleTree(alpha, beta)
        ...
        self.drawer = RandomHPLuvColorDrawer(self.figure, self.axes)

    @override
    def process(self) -> None:
        with Timer() as timer, timer.pushed("Random"):
