...
from ..data.christmas import (
    ChristmasProfilePictureMainTriangleData,
    ChristmasProfilePictureMainTriangleSymbolData,
    ChristmasProfilePictureNegativeTriangleData,
    ChristmasProfilePictureNegativeTriangleSymbolData)
...
class ChristmasProfilePicture(Processor):
    ...
    def __init__(
        self, *,
        output: str,
        hat: str = "resources/santa-hat.svg",
        figsize: float = 204.8,
        ...
        if alt:
            self.tree = TriangleTree(
                alpha, beta,
                color2=ChristmasProfilePictureMainTriangleData,
                color=ChristmasProfilePictureNegativeTriangleData,
            ...
            self.tree = TriangleTree(
                alpha, beta,
                color=ChristmasProfilePictureMainTriangleData,
                color2=ChristmasProfilePictureNegativeTriangleData,
                symbol_facecolor=ChristmasProfilePictureMainTriangleSymbolData,
                negative_symbol_facecolor=(
                    ChristmasProfilePictureNegativeTriangleSymbolData
                )
            )
    ...
    def process(self) -> None:
        with Timer() as timer, timer.pushed("Christmas"):
