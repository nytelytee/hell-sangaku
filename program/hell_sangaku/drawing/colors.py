...
import hsluv  # pyright: ignore[reportMissingTypeStubs]
...
def rgb_to_hsv(r: float, g: float, b: float, /) -> tuple[float, float, float]:
    h, cmax, _, delta = _rgb_to_hue_cmax_cmin_delta(r, g, b)
...
class ColorRGB(Color):
    ...
    @classmethod
    @override
    def mix(  # pyright: ignore[reportIncompatibleMethodOverride]
        cls, /,
        *args: Self | float 
    ) -> Self:
...
class ColorHSLuv(_ColorHSLuv_or_ColorHPLuv):
    ...
    def _from_rgb_function(
        ...
        return cast(
            tuple[float, float, float],
            hsluv.rgb_to_hsluv(  # pyright: ignore[reportUnknownMemberType]
                floats
            )
        )
    ...
    def _to_rgb_function(
        ...
        return cast(
            tuple[float, float, float],
            hsluv.hsluv_to_rgb(  # pyright: ignore[reportUnknownMemberType]
                floats
            )
        )
    ...
    def _to_hex_function(
        ...
        return hsluv.hsluv_to_hex(  # pyright: ignore[reportUnknownMemberType]
            floats
        )
...
class ColorHPLuv(_ColorHSLuv_or_ColorHPLuv):
    ...
    def _from_rgb_function(
        ...
        return cast(
            tuple[float, float, float],
            hsluv.rgb_to_hpluv(  # pyright: ignore[reportUnknownMemberType]
                floats
            )
        )
    ...
    def _to_rgb_function(
        ...
        return cast(
            tuple[float, float, float],
            hsluv.hpluv_to_rgb(  # pyright: ignore[reportUnknownMemberType]
                floats
            )
        )
    ...
    def _to_hex_function(
        ...
        return hsluv.hpluv_to_hex(  # pyright: ignore[reportUnknownMemberType]
            floats
        )
